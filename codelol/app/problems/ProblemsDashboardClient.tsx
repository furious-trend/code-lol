...
interface ProblemsDashboardClientProps {
  initialCompletedProblems: string[];
}

export default function ProblemsDashboardClient({ initialCompletedProblems }: ProblemsDashboardClientProps) {
  const [activeDifficulty, setActiveDifficulty] = useState<Difficulty>('Beginner');
  const [completedProblems] = useState<string[]>(initialCompletedProblems);
