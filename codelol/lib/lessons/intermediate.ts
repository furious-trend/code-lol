...
export const intermediateLessons: Lesson[] = [
  {
    ...
    sticker: "⏱️",
    funnyExplanation: "Big O Notation is how nerds brag about how fast their code is. O(1) is instant teleportation. O(n) is walking. O(n^2) is walking backward while tied to a snail.",
    codeExample: "// O(1) - Instant\nfunction getFirst(arr) { return arr[0]; }\n\n// O(n) - Linear (Depends on size)\nfunction logAll(arr) { arr.forEach(x => console.log(x)); }",
    gifKeyword: "snail walking slowly",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "💾",
    funnyExplanation: "Space complexity is how much RAM your code eats. If your code creates an array inside a loop inside a loop, Chrome is going to crash your computer.",
    ...
    gifKeyword: "computer catching fire",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    title: "Two Pointers",
    sticker: "✌️",
    funnyExplanation: "Two Pointers is like having two sets of eyes. One looks at the start of the array, the other looks at the end. They slowly walk towards each other until they kiss (or find the target sum).",
    codeExample: "let left = 0;\nlet right = arr.length - 1;\nwhile(left < right) {\n  // Do something smart\n  left++; right--;\n}",
    gifKeyword: "two people pointing at each other",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🪟",
    funnyExplanation: "Imagine staring through a tiny window on a train. As the train moves, the window slides over the scenery. That's a sliding window algorithm. It saves you from calculating the same scenery twice.",
    codeExample: "let windowSum = 0;\n// Add first k elements\nfor(let i=0; i<k; i++) windowSum += arr[i];\n// Slide the window\nfor(let i=k; i<arr.length; i++) {\n  windowSum += arr[i] - arr[i-k];\n}",
    gifKeyword: "looking through window train",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🗺️",
    funnyExplanation: "A Hash Map is a magic locker. You assign a label (key) to a box, put your stuff in it, and later, you can instantly grab it using just the label without searching the whole gym.",
    codeExample: "let map = new Map();\nmap.set('Shafiq', 'Cool Guy');\nconsole.log(map.get('Shafiq')); // O(1) Instant lookup!",
    gifKeyword: "magic locker opening",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🚫",
    funnyExplanation: "A Set is like an exclusive VIP club where duplicates are aggressively rejected by the bouncer. If you try to add the number 5 twice, the Set just laughs at you.",
    codeExample: "let mySet = new Set([1, 2, 2, 3, 3, 3]);\nconsole.log([...mySet]); // [1, 2, 3]",
    gifKeyword: "bouncer rejecting club",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🔗",
    funnyExplanation: "A Linked List is a scavenger hunt. Box A has a clue pointing to Box B. Box B points to Box C. If you lose the clue in Box A, you will never find Box C. Good luck.",
    codeExample: "class Node {\n  constructor(val) {\n    this.val = val;\n    this.next = null;\n  }\n}",
    gifKeyword: "treasure map scavenger hunt",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🐢",
    funnyExplanation: "If you have a linked list that loops infinitely (a cycle), you use a fast pointer (runs 2 steps) and a slow pointer (1 step). Eventually, the fast one laps the slow one, proving it's a loop. Just like NASCAR.",
    codeExample: "let slow = head, fast = head;\nwhile (fast && fast.next) {\n  slow = slow.next;\n  fast = fast.next.next;\n  if (slow === fast) return true; // CYCLE!\n}",
    gifKeyword: "turtle racing rabbit",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    title: "Stacks (LIFO)",
    sticker: "🥞",
    funnyExplanation: "A Stack is literally a stack of pancakes. You eat the one on TOP first. Last In, First Out (LIFO). If you try to pull one from the bottom, you ruin breakfast.",
    codeExample: "let stack = [];\nstack.push('Bottom');\nstack.push('Top');\nconsole.log(stack.pop()); // 'Top' comes off first",
    gifKeyword: "stack of pancakes syrup",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    title: "Queues (FIFO)",
    sticker: "🚶",
    funnyExplanation: "A Queue is just a line at Starbucks. First In, First Out (FIFO). If you cut the line (unshift), people will yell at you.",
    codeExample: "let queue = [];\nqueue.push('First Guy');\nqueue.push('Second Guy');\nconsole.log(queue.shift()); // First Guy gets served",
    gifKeyword: "waiting in long line",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🪞",
    funnyExplanation: "Recursion is a function calling itself until someone tells it to stop. It's like putting two mirrors facing each other. If you forget the 'stop' condition (Base Case), your computer crashes in an infinite mirror dimension.",
    codeExample: "function inception(n) {\n  if (n === 0) return 'Wake up!'; // Base case\n  return inception(n - 1);\n}",
    gifKeyword: "infinity mirror tunnel",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "📚",
    funnyExplanation: "When a recursive function calls itself, JS puts the old function on a 'Stack' and pauses it. If you stack too many paused functions, you get a 'Maximum Call Stack Size Exceeded' error. JS literally says 'Bro, I can't hold all these'.",
    codeExample: "function crashMe() {\n  crashMe();\n}\n// crashMe(); // RangeError: Maximum call stack size exceeded",
    gifKeyword: "dropping huge stack of papers",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🏗️",
    funnyExplanation: "A Class is just a blueprint. If the class is 'Car Blueprint', the Instance is the actual physical car you drive. You can't drive a blueprint, unless you're very imaginative and weird.",
    codeExample: "class Car {\n  drive() { console.log('Vroom!'); }\n}\nconst myCar = new Car(); // myCar is the Instance!\nmyCar.drive();",
    gifKeyword: "blueprint building house",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "👷",
    funnyExplanation: "The constructor is the setup crew. When you build the house (instance), the constructor runs once to set the paint color. The 'this' keyword means 'THIS specific house, not the neighbor's house'.",
    codeExample: "class User {\n  constructor(name) {\n    this.name = name; // Setting up THIS specific user\n  }\n}\nconst u1 = new User('Shafiq');\nconsole.log(u1.name);",
    gifKeyword: "construction worker pointing",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🧬",
    funnyExplanation: "Inheritance is when a child class copies everything from the parent class, but adds its own flair. It's like inheriting your dad's old car but putting neon lights on it.",
    codeExample: "class Animal {\n  breathe() { console.log('Breathing...'); }\n}\nclass Dog extends Animal {\n  bark() { console.log('Woof!'); }\n}\nconst d = new Dog();\nd.breathe(); d.bark();",
    gifKeyword: "father and son matching",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🔒",
    funnyExplanation: "Encapsulation is hiding your diary. You don't want anyone touching your internal variables directly. In JS, you put a `#` in front of a variable name to lock it up.",
    codeExample: "class BankAccount {\n  #balance = 0;\n  deposit(amt) { this.#balance += amt; }\n  getBalance() { return this.#balance; }\n}\nconst account = new BankAccount();\n// account.#balance; // ERROR! Private!",
    gifKeyword: "locking safe",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "🎭",
    funnyExplanation: "Polymorphism sounds like a disease, but it just means 'many forms'. If the parent class has a `speak()` method that says 'Hello', the child class can override it to say 'Sup bro'. Same method name, different behavior.",
    codeExample: "class Parent {\n  speak() { console.log('Hello'); }\n}\nclass Teenager extends Parent {\n  speak() { console.log('Whatever'); } // Overriding!\n}\nnew Teenager().speak();",
    gifKeyword: "transformers changing forms",
    miniQuizQuestion: {
  ...
  },
  {
    ...
    sticker: "⚡",
    funnyExplanation: "Static methods belong to the blueprint, not the house. You don't need to build the house to use them. It's like looking at the blueprint to find the architect's phone number.",
    codeExample: "class MathHelper {\n  static add(a, b) { return a + b; }\n}\n// No 'new' keyword needed!\nconsole.log(MathHelper.add(5, 5));",
    gifKeyword: "reading blueprint architecture",
    miniQuizQuestion: {
